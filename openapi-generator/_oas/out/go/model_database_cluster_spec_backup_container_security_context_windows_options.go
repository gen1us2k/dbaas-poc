...
// checks if the DatabaseClusterSpecBackupContainerSecurityContextWindowsOptions type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DatabaseClusterSpecBackupContainerSecurityContextWindowsOptions{}
...
func NewDatabaseClusterSpecBackupContainerSecurityContextWindowsOptions() *DatabaseClusterSpecBackupContainerSecurityContextWindowsOptions {
	this := DatabaseClusterSpecBackupContainerSecurityContextWindowsOptions{}
	return &this
}
...
func (o DatabaseClusterSpecBackupContainerSecurityContextWindowsOptions) MarshalJSON() ([]byte, error) {
...
func (o DatabaseClusterSpecBackupContainerSecurityContextWindowsOptions) ToMap() (map[string]interface{}, error) {
...
type NullableDatabaseClusterSpecBackupContainerSecurityContextWindowsOptions struct {
	value *DatabaseClusterSpecBackupContainerSecurityContextWindowsOptions
	isSet bool
}

func (v NullableDatabaseClusterSpecBackupContainerSecurityContextWindowsOptions) Get() *DatabaseClusterSpecBackupContainerSecurityContextWindowsOptions {
	return v.value
}

func (v *NullableDatabaseClusterSpecBackupContainerSecurityContextWindowsOptions) Set(val *DatabaseClusterSpecBackupContainerSecurityContextWindowsOptions) {
	v.value = val
	v.isSet = true
}

func (v NullableDatabaseClusterSpecBackupContainerSecurityContextWindowsOptions) IsSet() bool {
	return v.isSet
}

func (v *NullableDatabaseClusterSpecBackupContainerSecurityContextWindowsOptions) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDatabaseClusterSpecBackupContainerSecurityContextWindowsOptions(val *DatabaseClusterSpecBackupContainerSecurityContextWindowsOptions) *NullableDatabaseClusterSpecBackupContainerSecurityContextWindowsOptions {
	return &NullableDatabaseClusterSpecBackupContainerSecurityContextWindowsOptions{value: val, isSet: true}
}

func (v NullableDatabaseClusterSpecBackupContainerSecurityContextWindowsOptions) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDatabaseClusterSpecBackupContainerSecurityContextWindowsOptions) UnmarshalJSON(src []byte) error {
	v.isSet = true
