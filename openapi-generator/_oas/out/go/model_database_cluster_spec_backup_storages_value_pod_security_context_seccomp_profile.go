...
// checks if the DatabaseClusterSpecBackupStoragesValuePodSecurityContextSeccompProfile type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DatabaseClusterSpecBackupStoragesValuePodSecurityContextSeccompProfile{}
...
func NewDatabaseClusterSpecBackupStoragesValuePodSecurityContextSeccompProfile(type_ string) *DatabaseClusterSpecBackupStoragesValuePodSecurityContextSeccompProfile {
	this := DatabaseClusterSpecBackupStoragesValuePodSecurityContextSeccompProfile{}
	this.Type = type_
	return &this
}
...
func (o DatabaseClusterSpecBackupStoragesValuePodSecurityContextSeccompProfile) MarshalJSON() ([]byte, error) {
...
func (o DatabaseClusterSpecBackupStoragesValuePodSecurityContextSeccompProfile) ToMap() (map[string]interface{}, error) {
...
type NullableDatabaseClusterSpecBackupStoragesValuePodSecurityContextSeccompProfile struct {
	value *DatabaseClusterSpecBackupStoragesValuePodSecurityContextSeccompProfile
	isSet bool
}

func (v NullableDatabaseClusterSpecBackupStoragesValuePodSecurityContextSeccompProfile) Get() *DatabaseClusterSpecBackupStoragesValuePodSecurityContextSeccompProfile {
	return v.value
}

func (v *NullableDatabaseClusterSpecBackupStoragesValuePodSecurityContextSeccompProfile) Set(val *DatabaseClusterSpecBackupStoragesValuePodSecurityContextSeccompProfile) {
	v.value = val
	v.isSet = true
}

func (v NullableDatabaseClusterSpecBackupStoragesValuePodSecurityContextSeccompProfile) IsSet() bool {
	return v.isSet
}

func (v *NullableDatabaseClusterSpecBackupStoragesValuePodSecurityContextSeccompProfile) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDatabaseClusterSpecBackupStoragesValuePodSecurityContextSeccompProfile(val *DatabaseClusterSpecBackupStoragesValuePodSecurityContextSeccompProfile) *NullableDatabaseClusterSpecBackupStoragesValuePodSecurityContextSeccompProfile {
	return &NullableDatabaseClusterSpecBackupStoragesValuePodSecurityContextSeccompProfile{value: val, isSet: true}
}

func (v NullableDatabaseClusterSpecBackupStoragesValuePodSecurityContextSeccompProfile) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDatabaseClusterSpecBackupStoragesValuePodSecurityContextSeccompProfile) UnmarshalJSON(src []byte) error {
	v.isSet = true
