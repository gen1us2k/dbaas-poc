...
// checks if the DatabaseClusterSpecBackupStoragesValueAffinityPodAntiAffinity type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DatabaseClusterSpecBackupStoragesValueAffinityPodAntiAffinity{}
...
func NewDatabaseClusterSpecBackupStoragesValueAffinityPodAntiAffinity() *DatabaseClusterSpecBackupStoragesValueAffinityPodAntiAffinity {
	this := DatabaseClusterSpecBackupStoragesValueAffinityPodAntiAffinity{}
	return &this
}
...
func (o DatabaseClusterSpecBackupStoragesValueAffinityPodAntiAffinity) MarshalJSON() ([]byte, error) {
...
func (o DatabaseClusterSpecBackupStoragesValueAffinityPodAntiAffinity) ToMap() (map[string]interface{}, error) {
...
type NullableDatabaseClusterSpecBackupStoragesValueAffinityPodAntiAffinity struct {
	value *DatabaseClusterSpecBackupStoragesValueAffinityPodAntiAffinity
	isSet bool
}

func (v NullableDatabaseClusterSpecBackupStoragesValueAffinityPodAntiAffinity) Get() *DatabaseClusterSpecBackupStoragesValueAffinityPodAntiAffinity {
	return v.value
}

func (v *NullableDatabaseClusterSpecBackupStoragesValueAffinityPodAntiAffinity) Set(val *DatabaseClusterSpecBackupStoragesValueAffinityPodAntiAffinity) {
	v.value = val
	v.isSet = true
}

func (v NullableDatabaseClusterSpecBackupStoragesValueAffinityPodAntiAffinity) IsSet() bool {
	return v.isSet
}

func (v *NullableDatabaseClusterSpecBackupStoragesValueAffinityPodAntiAffinity) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDatabaseClusterSpecBackupStoragesValueAffinityPodAntiAffinity(val *DatabaseClusterSpecBackupStoragesValueAffinityPodAntiAffinity) *NullableDatabaseClusterSpecBackupStoragesValueAffinityPodAntiAffinity {
	return &NullableDatabaseClusterSpecBackupStoragesValueAffinityPodAntiAffinity{value: val, isSet: true}
}

func (v NullableDatabaseClusterSpecBackupStoragesValueAffinityPodAntiAffinity) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDatabaseClusterSpecBackupStoragesValueAffinityPodAntiAffinity) UnmarshalJSON(src []byte) error {
	v.isSet = true
